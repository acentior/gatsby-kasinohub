    ...
    return (
     <Layout location={this.props.location}>
          <GatsbySeo
            ...
            canonical='https://kasinohub.com/eurojackpot/'
            languageAlternates={[
              {
                hrefLang: 'fi-FI',
                href: 'https://kasinohub.com/eurojackpot/',
              },
            ]}
            metaTags={[ 
              {
          ...
          />
          <ArticleJsonLd
            url='https://kasinohub.com/eurojackpot/'
            headline={`${page.title}`}
            images={[
              `${page.kuva.file.url}`
            ]}
         ...
         <div className="container">
            ...
            <div className="wrapper">
              ...
              <h3 className="listHead">Voit pelata Eurojackpotia näillä sivustoilla:</h3>  
                    ...
                    <td className="casinotop">
                      ...
                      <div className="contentBox second">
                        <div className="contentText">
                          {listatekstit !== null &&
                            <div>{listatekstit.eurojackpotSivuTopLista.eurojackpotSivuTopLista}</div>
                          }
                          {listatekstit == null &&
                            <div>-</div>
                          }
...
export const pageQuery = graphql`
  query EurojackpotQuery {
    site {
      siteMetadata {
        title
      }
    }
    contentfulPagePeruspohja(title: {eq: "Eurojackpot"}) {
      title
      seoBrowserTitle
      seoMetaDescription
