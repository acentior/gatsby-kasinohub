...
class Hedelmapelit extends React.Component {
  componentDidMount() {
    ...
    return (
     <Layout location={this.props.location}>
          <GatsbySeo
            ...
            canonical='https://kasinohub.com/hedelmapelit/'
            languageAlternates={[
              {
                hrefLang: 'fi-FI',
                href: 'https://kasinohub.com/hedelmapelit/',
              },
            ]}
            metaTags={[ 
              {
          ...
          />
          <ArticleJsonLd
            url='https://kasinohub.com/hedelmapelit/'
            headline={`${page.title}`}
            images={[
              `${page.kuva.file.url}`
            ]}
         ...
         <div className="container">
            ...
            <div className="wrapper">
              ...
              <h3 className="listHead">Parhaat hedelmäpelit löytyvät näiltä pelisivuilta:</h3>
              <table className="casinoTable">
                <tbody>
                {page.topLista.map(({kasinonNimi,kasinonSlug,poistaLinkkiArvosteluun,affiliateLinkki,arvostelu,snntJaEhdot,bonusRaha,ilmaiskierrokset,listatekstit,kasinonPieniLogo}) => (
                    ...
                    <td className="casinotop">
                      ...
                      <div className="contentBox second">
                        <div className="contentText">
                          {listatekstit !== null &&
                            <div>{listatekstit.hedelmpelitSivuTopLista.hedelmpelitSivuTopLista}</div>
                          }
                          {listatekstit == null &&
                            <div>-</div>
                          }
...
export default Hedelmapelit

export const pageQuery = graphql`
  query HedelmapelitQuery {
    site {
      siteMetadata {
        title
      }
    }
    contentfulPagePeruspohja(title: {eq: "Hedelmäpelit"}) {
      title
      seoBrowserTitle
      seoMetaDescription
