...
class Kayttoehdot extends React.Component {
  componentDidMount() {
    ...
    return (
     <Layout location={this.props.location}>
          <GatsbySeo
            ...
            canonical='https://kasinohub.com/kayttoehdot/'
            languageAlternates={[
              {
                hrefLang: 'fi-FI',
                href: 'https://kasinohub.com/kayttoehdot/',
              },
            ]}
            metaTags={[ 
              {
...
export const pageQuery = graphql`
  query KayttoehdotQuery {
    site {
      siteMetadata {
        title
      }
    }
    contentfulPageTietoaMeista(title: {eq: "Käyttöehdot"}) {
        title
        seoBrowserTitle
        seoMetaDescription
        ylaosanTeksti1 {
