    ...
    return (
     <Layout location={this.props.location}>
          <GatsbySeo
            ...
            canonical='https://kasinohub.com/keno/'
            languageAlternates={[
              {
                hrefLang: 'fi-FI',
                href: 'https://kasinohub.com/keno/',
              },
            ]}
            metaTags={[ 
              {
         ...
         <div className="container">
            ...
            <div className="wrapper">
              ...
              <h3 className="listHead">Voit pelata kenoa näillä sivustoilla:</h3>  
                    ...
                    <td className="casinotop">
                      ...
                      <div className="contentBox second">
                        <div className="contentText">
                          {listatekstit !== null &&
                            <div>{listatekstit.kenoSivuTopLista.kenoSivuTopLista}</div>
                          }
                          {listatekstit == null &&
                            <div>-</div>
                          }
...
export const pageQuery = graphql`
  query KenoQuery {
    ...
    contentfulPagePeruspohja(title: {eq: "Keno"}) {
      title
      seoBrowserTitle
      seoMetaDescription
