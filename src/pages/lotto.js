    ...
    return (
     <Layout location={this.props.location}>
          <GatsbySeo
            ...
            canonical='https://kasinohub.com/lotto/'
            languageAlternates={[
              {
                hrefLang: 'fi-FI',
                href: 'https://kasinohub.com/lotto/',
              },
            ]}
            metaTags={[ 
              {
         ...
         <div className="container">
            ...
            <div className="wrapper">
              <div className="wrapperText">
               ...
               <h3 className="listHead">Pelaa lottoa netissä näillä sivustoilla:</h3>
                    ...
                    <td className="casinotop">
                      ...
                      <div className="contentBox second">
                        <div className="contentText">
                          {listatekstit !== null &&
                            <div>{listatekstit.lottoSivuTopLista.lottoSivuTopLista}</div>
                          }
                          {listatekstit == null &&
                            <div>-</div>
                          }
...
export const pageQuery = graphql`
  query LottoQuery {
    ...
    contentfulPagePeruspohja(title: {eq: "Lotto"}) {
      title
      seoBrowserTitle
      seoMetaDescription
