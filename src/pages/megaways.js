...
class Megaways extends React.Component {
  componentDidMount() {
    ...
    return (
     <Layout location={this.props.location}>
          <GatsbySeo
            ...
            canonical='https://kasinohub.com/megaways/'
            languageAlternates={[
              {
                hrefLang: 'fi-FI',
                href: 'https://kasinohub.com/megaways/',
              },
            ]}
            metaTags={[ 
              {
          ...
          />
          <ArticleJsonLd
            url='https://kasinohub.com/megaways/'
            headline={`${page.title}`}
            images={[
              `${page.kuva.file.url}`
            ]}
         ...
         <div className="container">
            ...
            <div className="wrapper">
              ...
              <h3 className="listHead">Paras tarjonta Megaways pelejä löytyy näiltä pelisivuilta:</h3>
              <table className="casinoTable">
                <tbody>
                {page.topLista.map(({kasinonNimi,kasinonSlug,affiliateLinkki,poistaLinkkiArvosteluun,snntJaEhdot,arvostelu,bonusRaha,ilmaiskierrokset,listatekstit,kasinonPieniLogo}) => (
                    ...
                    <td className="casinotop">
                      ...
                      <div className="contentBox second">
                        <div className="contentText">
                          {listatekstit !== null &&
                            <div>{listatekstit.megawaysSivuTopLista.megawaysSivuTopLista}</div>
                          }
                          {listatekstit == null &&
                            <div>-</div>
                          }
...
export const pageQuery = graphql`
  query MegawaysQuery {
    ...
    contentfulPagePeruspohja(title: {eq: "Megaways"}) {
      title
      seoBrowserTitle
      seoMetaDescription
