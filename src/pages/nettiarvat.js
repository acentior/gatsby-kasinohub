...
class Raaputusarvat extends React.Component {
  componentDidMount() {
    ...
    return (
     <Layout location={this.props.location}>
          <GatsbySeo
            ...
            canonical='https://kasinohub.com/nettiarvat/'
            languageAlternates={[
              {
                hrefLang: 'fi-FI',
                href: 'https://kasinohub.com/nettiarvat/',
              },
            ]}
            metaTags={[ 
              {
          ...
          />
          <ArticleJsonLd
            url='https://kasinohub.com/nettiarvat/'
            headline={`${page.title}`}
            images={[
              `${page.kuva.file.url}`
            ]}
         ...
         <div className="container">
            ...
            <div className="wrapper">
              ...
              <h3 className="listHead">Raaputa nettiarpoja näillä loistavilla pelisivuilla</h3>
                    ...
                    <td className="casinotop">
                      ...
                      <div className="contentBox second">
                        <div className="contentText">
                          {listatekstit !== null &&
                            <div>{listatekstit.nettiarvatSivuTopLista.nettiarvatSivuTopLista}</div>
                          }
                          {listatekstit == null &&
                            <div>-</div>
                          }
...
export default Raaputusarvat

export const pageQuery = graphql`
  query RaaputusarvatQuery {
    site {
      siteMetadata {
        title
      }
    }
    contentfulPagePeruspohja(title: {eq: "Nettiarvat"}) {
    title
    seoBrowserTitle
    seoMetaDescription
